...
// in user_list_app/test/features/user_list/data/repositories/user_repository_impl_test.dart.
...
class MockUserLocalDataSource extends _i1.Mock
  ...
  _i4.Future<List<_i2.UserModel>> getUsers() =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i4.Future<List<_i2.UserModel>>.value(
              <_i2.UserModel>[],
            ),
          )
  ...
  @override
  _i4.Future<_i2.UserModel> addUser(String? name) =>
      (super.noSuchMethod(
            Invocation.method(#addUser, [name]),
            returnValue: _i4.Future<_i2.UserModel>.value(
              _FakeUserModel_0(this, Invocation.method(#addUser, [name])),
            ),
